                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('co_name') ? ' has-error' : '' }}">
                            <label for="co_name" class="col-md-4 control-label">Company Name</label>

                            <div class="col-md-6">
                                <input id="co_name" type="text" class="form-control" name="co_name" value="{{ old('co_name') }}" required autofocus>
