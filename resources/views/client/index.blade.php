        ...
        <div class='col-md-3 pull-md-9'>
            <div class='panel panel-default'>
                <div class='panel-body text-center'>
                    ...
                    <button style='margin:10px 0; margin-top:60px' class='btn btn-success'>New Job Order</button>
                        ...
                        @foreach($items as $item)
                            ...
                            <a class='my_popup_open' href='#'>
                                <div class="col-md-4 light-panel item" name='{{$item->item_id}}'>
                                    <div class='inner'>
                                        <img class='item_image' src='uploads/{{$item->item_image}}'>
            ...
            $('.item').on('click', function(){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#single-item-image').attr("src", 'uploads/' + data[0]['item_image']);
                        console.log(data);
                    },
                    error: function(xhr) {
